...
router.post('/change-password', (0, validateRequest_1.default)(auth_validation_1.authValidation.changePasswordZodSchema), (0, auth_1.default)(client_1.UserRole.SUPER_ADMIN, client_1.UserRole.ADMIN, client_1.UserRole.USER), auth_controller_1.authController.changePassword);
